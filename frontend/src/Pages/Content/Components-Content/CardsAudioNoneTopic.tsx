...
import { Card,List,Dropdown,Menu,Row,Col,Button,Space, message, Popover ,Modal} from "antd"
import { 
  EllipsisOutlined,
  CheckOutlined,
  CloseCircleOutlined,
...
const CardsAudioNoneTopic = ({tab,dataVideo,keyword,setContent,content,setAction,action}:any) => {
...
export default CardsAudioNoneTopic